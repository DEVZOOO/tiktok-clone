...
class S {
  ...
  String signUpTitle(String nameOfTheApp, DateTime when) {
    final DateFormat whenDateFormat = DateFormat.yMd(Intl.getCurrentLocale());
  ...
  String loginTitle(String nameOfTheApp) {
    return Intl.message(
      'Login into your $nameOfTheApp account.',
      name: 'loginTitle',
      desc: 'when they open the login screen.',
      args: [nameOfTheApp],
    );
  }
  ...
  /// `{value} {comments, plural, =0{no comments} =1{comment} other{comments}}`
  String commentTitle(int value, num comments) {
    final NumberFormat valueNumberFormat = NumberFormat.compact(
      locale: Intl.getCurrentLocale(),
    );
    final String valueString = valueNumberFormat.format(value);
    ...
    return Intl.message(
      '$valueString ${Intl.plural(comments, zero: 'no comments', one: 'comment', other: 'comments')}',
      name: 'commentTitle',
      desc: '',
      args: [valueString, comments],
    );
  }
}
