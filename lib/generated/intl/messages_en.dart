...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(value, comments) =>
      "${value} ${Intl.plural(comments, zero: 'no comments', one: 'comment', other: 'comments')}";
  ...
  static String m4(nameOfTheApp) => "Login into your ${nameOfTheApp} account.";
